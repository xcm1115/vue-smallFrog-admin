<template>
    <div>
        <el-card>
            <el-table :height="tableHeight" :data="enBooks.slice((currentPage-1)*pagesize,currentPage*pagesize).filter(data => !search || data.Name.toLowerCase().includes(search.toLowerCase()))" highlight-current-row stripe>
            ...
            <el-row style="margin-top: 20px;">
                ...
                <el-col :span="16">
                    <el-pagination class="page" background @current-change="handleCurrentChange" :current-page="currentPage" :page-size="pagesize" layout="total, prev, pager, next, jumper" :total="enBooks.length">
                    </el-pagination>
                </el-col>
            </el-row>
        </el-card>
...
<script>
    ...
    export default {
        ...
        created() {
            var address = "https://www.xiaoqw.online/smallFrog-manager/server/enBooks.php";
